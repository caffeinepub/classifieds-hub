...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Listing as _Listing, ListingStatus as _ListingStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createListing(arg0: string, arg1: string, arg2: bigint, arg3: Category, arg4: string, arg5: Array<ExternalBlob>, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createListing(arg0, arg1, arg2, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg3), arg4, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListing(arg0: bigint): Promise<Listing> {
        if (this.processError) {
            try {
                ...
                return from_candid_Listing_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getListingsByCategory(arg0: Category): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingsByCategory(to_candid_Category_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getListingsByLocation(arg0: string): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getListingsByLocation(arg0);
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserListings(): Promise<Array<Listing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserListings();
                return from_candid_vec_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateListing(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: Category, arg5: string, arg6: Array<ExternalBlob>, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateListing(arg0, arg1, arg2, arg3, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg4), arg5, await to_candid_vec_n12(this._uploadFile, this._downloadFile, arg6), arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Listing_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Listing): Promise<Listing> {
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "vehicles" in value ? Category.vehicles : "realEstate" in value ? Category.realEstate : "furniture" in value ? Category.furniture : "fashion" in value ? Category.fashion : "services" in value ? Category.services : "electronics" in value ? Category.electronics : value;
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Listing>): Promise<Array<Listing>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Listing_n15(_uploadFile, _downloadFile, x)));
}
